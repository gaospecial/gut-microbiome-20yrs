...
国际化在“肠道菌群”研究论文中很常见（图 \@ref(fig:MCP-SCP）。在最主要的`r topN`国家中，美国的研究有近 20% 是与其它国家合作完成的，中国发表的论文中也有约 20% 的文章是与其它国家合作完成的；英、法、德、意、加等国的合作研究比例在 30% 附近或者更高。比较例外的是日本，仅有 13% 的研究与其它国家合作完成。
...
# netMatrix[nchar(colnames(netMatrix))!= 0, nchar(colnames(netMatrix)) !=0]
net <- networkPlot(NetMatrix = netMatrix,n=20,Title = "国家间的合作",type = "kamada",size = T,remove.multiple = F,remove.isolates = F)
```
...
LCS可以快速定位一个领域的经典文献。一篇文章GCS很高，说明被全球科学家关注较多。但是如果一篇GCS很高，而LCS很小，说明这种关注主要来自与你不是同一领域的科学家。此时，这篇文献对你的参考意义可能不大。
...
我们知道引用有一定的延后性，而 LCR 可以帮助我们快速找出最新的文献中哪些是和自己研究方向最相关的文章。
