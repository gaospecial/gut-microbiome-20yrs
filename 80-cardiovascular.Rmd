...
papers <- readRDS(paste0(db_cache,"papers.RDS")) %>% as_tibble() %>%  mutate_all(iconv,from="utf-8",sub=" ")
fragments <- readRDS(paste0(db_cache,"fragments.RDS")) %>% as_tibble() %>%  mutate_all(iconv,from="utf-8",sub=" ")
